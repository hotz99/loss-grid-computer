...
def main() -> None:
    args = build_config(**parse_overrides())
    set_seed(args.seed)
...
def parse_overrides() -> dict[str, object]:
    parser = argparse.ArgumentParser(
        description="Train the CIFAR-10 Row-GRU classifier checkpoint.",
    )
...
def build_config(**overrides: object) -> SimpleNamespace:
    defaults = {
        ...
        "output": Path("assets/cifar10-row-gru-0.pkl"),
        "device": "auto",
        "epochs": 80,
        "batch_size": 512,
        "lr": 3e-3,
