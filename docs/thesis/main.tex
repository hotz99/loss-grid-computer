...
NOTE: inspired by LossLens; should we drop this ?
...
The sequential \texttt{functional\_call} candidate is therefore a
...
absolute differences uninformative, so scheduler rows are accepted using
