...
from loss_grid.backends.vanilla_compiled import CompiledVanillaGpuLossGridExecutor
...
def make_executor(config: ExperimentConfig) -> LossGridExecutor:
    ...
    if backend == "vanilla_compiled":
        return CompiledVanillaGpuLossGridExecutor()
    if backend == "hybrid":
...
__all__ = [
    "LossGridExecutor",
    "make_executor",
    "VanillaGpuLossGridExecutor",
    "CompiledVanillaGpuLossGridExecutor",
]
